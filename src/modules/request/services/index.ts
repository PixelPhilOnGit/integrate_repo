...
import { createTauriRequestClient } from './tauri';
import { createWebRequestClient } from './web';
import type { RequestClient } from './types';

export const requestClient: RequestClient = isTauri()
  ? createTauriRequestClient()
  : createWebRequestClient();
